...
import com.sheria.hashgenerator.databinding.FragmentSuccessBinding
...
class SuccessFragment : Fragment() {
    ...
    private suspend fun applyAnimation(){
        binding.include.messageBackground.animate().translationY(80f)
            .duration=200L
        binding.include.messageTextView.animate().translationY(80f)
            .duration=200L
